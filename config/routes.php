...
$app->get('/statistic', 'App\Controllers\HomeController:statistic');
$app->get('/pricing', 'App\Controllers\HomeController:pricing');
$app->get('/doc', 'App\Controllers\HomeController:doc');
